...
def initiate():
    ...
    car_make_data = [
        ...
        },
        {
            ...
            "description": (
                "Mercedes-Benz AG. "
                "Luxury and commercial "
                "vehicle automotive brand."
            ),
        ...
        },
        {
            "name": "Audi",
            "description": (
                "Audi AG. German manufacturer "
                "of luxury vehicles, a member "
    ...
    nissan_make = car_make_instances[0]
    mercedes_make = car_make_instances[1]
    audi_make = car_make_instances[2]
    kia_make = car_make_instances[3]
    toyota_make = car_make_instances[4]
    ...
    car_model_data = [
        ...
        # Mercedes-Benz (car_make_instances[1])
        {
            ...
            "type": "SEDAN",
            "year": 2023,
            "car_make": mercedes_make,
            "trim_level": "A220 AMG Line",
            "engine_type": "ICE",
            "transmission": "AUTOMATIC",
            "base_price": 39500.00,
            "image_url": (
        ...
        # Kia (car_make_instances[3])
        {
            ...
            "year": 2023,
            "car_make": kia_make,
            "trim_level": "SX Prestige",
            "engine_type": "HEV",
            "transmission": "AUTOMATIC",
            "base_price": 43000.00,
            "image_url": (
                "https://images.unsplash.com/"
                "photo-1655821888788-6107699e1700"
                "?auto=format&fit=crop&w=800&q=80"
            ),
        },
        {
        ...
        },
        {
            ...
            "image_url": (
                "https://images.unsplash.com/"
                "photo-1623854275632-e06283ec31d8"
                "?auto=format&fit=crop&w=800&q=80"
            ),
        },
        # Toyota (car_make_instances[4])
        {
            ...
            "type": "SEDAN",
            "year": 2023,
            "car_make": toyota_make,
            "trim_level": "LE Hybrid",
            "engine_type": "HEV",
            "transmission": "CVT",
            "base_price": 23050.00,
            "image_url": (
                "https://images.unsplash.com/"
                "photo-1621007947382-cc347941fd17"
                "?auto=format&fit=crop&w=800&q=80"
            ),
        },
        {
            ...
            "image_url": (
                "https://images.unsplash.com/"
                "photo-1621007974902-0941977f904b"
                "?auto=format&fit=crop&w=800&q=80"
            ),
        },
        {
